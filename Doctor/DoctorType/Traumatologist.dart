...
class Traumatologist extends Doctor {

  //ATRIBUTOS
  List<Appointment> appointments;

  //CONSTRUCTOR
  Traumatologist(String name, List<Specialty<SpecialitiesName>> specialty, this.appointments) :  super(name, specialty, appointments);  
